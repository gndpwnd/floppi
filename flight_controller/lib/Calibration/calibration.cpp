...
void printRadioCalibrationResults(int throttleChannel, int rollChannel, int pitchChannel, int yawChannel, int aux1Channel, int aux2Channel) {
    ...
    Serial.println(F("\n📋 STEP 4: Comment out '#define RUN_RADIO_CALIBRATION' in config.h"));
    Serial.println(F("📋 STEP 5: Upload code again\n"));
...
void printIMUCalibrationResults(float AccErrorX, float AccErrorY, float AccErrorZ, float GyroErrorX, float GyroErrorY, float GyroErrorZ) {
    ...
    Serial.println(F("//============================================================================="));
    Serial.print(F("float AccErrorX = ")); Serial.print(AccErrorX, 6); Serial.println(F(";"));
    Serial.print(F("float AccErrorY = ")); Serial.print(AccErrorY, 6); Serial.println(F(";"));
    Serial.print(F("float AccErrorZ = ")); Serial.print(AccErrorZ, 6); Serial.println(F(";"));
    Serial.println();
    Serial.print(F("float GyroErrorX = ")); Serial.print(GyroErrorX, 6); Serial.println(F(";"));
    Serial.print(F("float GyroErrorY = ")); Serial.print(GyroErrorY, 6); Serial.println(F(";"));
    Serial.print(F("float GyroErrorZ = ")); Serial.print(GyroErrorZ, 6); Serial.println(F(";"));
    Serial.println();
    
    Serial.println(F("\n📋 STEP 4: Comment out '#define RUN_IMU_CALIBRATION' in config.h"));
    Serial.println(F("📋 STEP 5: Upload the code again"));
    Serial.println(F("📋 STEP 6: Your IMU is now calibrated!\n"));
...
void printIMUOrientationResults(char forwardAxis, bool forwardInverted, char rightAxis, bool rightInverted, char upAxis, bool upInverted) {
    ...
    Serial.println(F("\n📋 Comment out '#define RUN_IMU_ORIENTATION' in config.h"));
    Serial.println(F("📋 Upload code again\n"));
