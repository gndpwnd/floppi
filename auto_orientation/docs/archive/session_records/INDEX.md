...
| 2026-05-21 | [multi_agent_workstream_g_security](2026-05-21_multi_agent_workstream_g_security.md) | Workstream G bench-tuning support (G1/G2/G3/Gap-3 telemetry + `g` command + host plotting), Phase 4M.14 test-coverage closure (native 17/17), two P1 calibration-storage security fixes (mounting CRC + `restoreFromEEPROM()` buffer-overflow), platformio.ini de-dup, doc-drift fixes. All 6 firmware envs green. Uncommitted. |
