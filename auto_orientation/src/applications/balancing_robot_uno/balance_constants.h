 ...
 *                                   --output <this-file>
 *
 * Generated:    2026-05-20 00:46:23 EDT
 * Generator:    brute_tune.py v1.2
 * Search:       mode=evolutionary  budget=5000  seed=42
 * Plant preset: uno_small
 * Fitness:      3.272   (8.000s balanced, tip=no)
 * Trial:        init_perturbation=8.0deg,
 *               disturbance=500.0dps² period=0.8s
 *
